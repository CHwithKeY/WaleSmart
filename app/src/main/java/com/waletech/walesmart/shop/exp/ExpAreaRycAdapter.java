 ...
 */
public class ExpAreaRycAdapter extends RecyclerView.Adapter<ExpAreaRycAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
...
//            "31", "32", "33"};
    ...
    private boolean isCabinetDialog;

    public void setCabinetDialog(boolean cabinetDialog) {
        isCabinetDialog = cabinetDialog;
    }

    public ExpAreaRycAdapter(ArrayList<ObjectShoe> shoeList, int row, int column) {
...
//        }
        ...
        for (int i = 0; i < shoeList.size(); i++) {
            ...
            if (native_number[position].equals(remote_number) || isCabinetDialog) {
